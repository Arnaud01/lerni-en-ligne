(function(){   // anonymous wrapper : rien n'a besoin d'être global
	...
	var app = angular.module('myApp.controllerTablesAddition',[]);

	app.controller('CtrlTablesAddition', function($scope, $http, $localStorage) {
				...
				$scope.s = 's';
						...
						if ($scope.note == 10) { // si tout est juste : vert
							...
							if (typeof $scope.prenomTablesAddition != 'undefined') { // si la variable prenoms existe
								...
								$scope.prenomTablesAddition[$scope.serie] = 'green';

								$localStorage[$scope['prenomCompile']] = $scope.prenomTablesAddition; // écriture
								...
								$localStorage[$scope['prenomCompile']] = $scope.prenomTablesAddition; // mise à jour
						...
						if (typeof $scope.prenomTablesAddition != 'undefined') { // si la variable prenoms existe
							...
							$scope.prenomTablesAddition[$scope.serie] = 'yellow';
						...
						if (typeof $scope.prenomTablesAddition != 'undefined') { // si la variable prenoms existe
							...
							$scope.prenomTablesAddition[$scope.serie] = 'orange';
						...
						if (typeof $scope.prenomTablesAddition != 'undefined') { // si la variable prenoms existe
							...
							$scope.prenomTablesAddition[$scope.serie] = 'red';
